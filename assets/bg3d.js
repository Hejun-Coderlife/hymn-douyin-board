...
(function () {
  ...
  var PEARL = [
    ...
    '    vec3 s=tint*(0.93+0.11*diff)+vec3(1.0,0.99,0.97)*spec*0.22+tint*rim*0.07;',
    '    float a=smoothstep(1.34,0.80,q);',
    '    col=mix(col,s,a*0.52);',
    '  }',
    '  return col;',
    '}',
    ...
    '  vec3 cream=vec3(0.996,0.982,0.962);',
    '  vec3 peach=vec3(0.996,0.948,0.906);',
    '  vec3 sand =vec3(0.988,0.962,0.918);',
